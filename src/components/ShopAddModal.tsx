...
export default function ShopAddModal({ org, onClose, onSaved }: ShopAddModalProps) {
  ...
  const [ramenTypes, setRamenTypes] = useState<string[]>([])
  const mapRef = useRef<HTMLDivElement>(null)
  const [mapLoaded, setMapLoaded] = useState(false)

  useEffect(() => {
    // Simple search-based place input (Maps API optional)
    setMapLoaded(true)
  }, [])
